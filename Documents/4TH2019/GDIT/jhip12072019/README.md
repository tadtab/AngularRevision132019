...
To build the final jar and optimize the jhip12072019 application for production, run:
...
Then navigate to [http://localhost:8283](http://localhost:8283) in your browser.
